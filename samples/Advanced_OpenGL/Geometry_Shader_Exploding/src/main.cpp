...
int main()
{
	...
	// ------------------------------------
	Shader shader(FileSystem::getSamplePath("shader/geometry_shader.vert").c_str(), FileSystem::getSamplePath("shader/geometry_shader.frag").c_str(), FileSystem::getSamplePath("shader/geometry_shader.geom").c_str());
	Shader normalDisplayShader(FileSystem::getSamplePath("shader/normalShader.vert").c_str(), FileSystem::getSamplePath("shader/normalShader.frag").c_str(), FileSystem::getSamplePath("shader/normalShader.geom").c_str());
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.setInt("explodeB", explode);

		// add time component to geometry shader in the form of a uniform
		if (!explode) {
			timeToExpl = glfwGetTime();
		}
		
		shader.setFloat("time", glfwGetTime()- timeToExpl);
