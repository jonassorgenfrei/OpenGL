...
public:
	...
	{	
		...
		// Setup update shader
		// -------------------
		std::vector<const GLchar*> Varyings;// array of strings with the name of the attributes
		...
		particleUpdateShader = new TransformFeedbackShader(
											Varyings,
											FileSystem::getSamplePath("shader/particleUpdate.vert").c_str(), 
											FileSystem::getSamplePath("shader/particleUpdate.frag").c_str(), 
											FileSystem::getSamplePath("shader/particleUpdate.geom").c_str());
