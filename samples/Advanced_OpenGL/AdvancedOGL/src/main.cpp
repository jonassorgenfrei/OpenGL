...
int main()
{
	...
	*/
	...
	// ------------------------------------
	Shader shader(FileSystem::getSamplePath("shader/shader.vert").c_str(), FileSystem::getSamplePath("shader/shader.frag").c_str());
	Shader shaderSingleColor(FileSystem::getSamplePath("shader/shader.vert").c_str(), FileSystem::getSamplePath("shader/shaderSingleColor.frag").c_str());
	Shader screenShader(FileSystem::getSamplePath("shader/framebufferShader.vert").c_str(), FileSystem::getSamplePath("shader/framebufferShader.frag").c_str());
	Shader skyboxShader(FileSystem::getSamplePath("shader/skyShader.vert").c_str(), FileSystem::getSamplePath("shader/skyShader.frag").c_str());
	Shader reflectionShader(FileSystem::getSamplePath("shader/reflection.vert").c_str(), FileSystem::getSamplePath("shader/reflection.frag").c_str());
	Shader refractionShader(FileSystem::getSamplePath("shader/refraction.vert").c_str(), FileSystem::getSamplePath("shader/refraction.frag").c_str());
