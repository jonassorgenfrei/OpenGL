...
int main()
{
	...
	// ------------------------------------
	Shader ourShader(FileSystem::getSamplePath("shader/cube.vert").c_str(), FileSystem::getSamplePath("shader/cube.frag").c_str());
	...
	float vertices[] = {
		...
		//second
		// 2 0.5f,  0.5f, -0.5f,  1.0f, 0.0f, 0.0f,  1.0f, 1.0f,
		...
		//forth
		// 6 0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 0.0f,  1.0f, 1.0f,
		-0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 0.0f,  0.0f, 1.0f, //7
		// 4 -0.5f, -0.5f,  0.5f,  0.0f, 1.0f, 0.0f,  0.0f, 0.0f,
		...
		// 12 0.5f,  0.5f,  0.5f,  1.0f, 1.0f, 0.0f,  1.0f, 0.0f, 
		...
		//tenth
		// 18 0.5f, -0.5f,  0.5f,  1.0f, 1.0f, 1.0f,  1.0f, 0.0f,
		-0.5f, -0.5f,  0.5f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f, //19
		// 16 -0.5f, -0.5f, -0.5f,  1.0f, 1.0f, 1.0f,  0.0f, 1.0f,
		...
		//twelves
		// 22 0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 1.0f,  1.0f, 0.0f,
		-0.5f,  0.5f,  0.5f,  0.0f, 1.0f, 1.0f,  0.0f, 0.0f, //23
		// 20 -0.5f,  0.5f, -0.5f,  0.0f, 1.0f, 1.0f,  0.0f, 1.0f
	};
	...
	/* Lamp */
	Light light = Light(0.0f, 0.0f, 0.0f,	// xyz
						1.0f, 1.0f, 1.0f);	// rgb
	...
	ourShader.setVec3("lightColor", light.diffuse);
