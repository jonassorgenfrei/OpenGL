...
int main()
{
	...
	// ------------------------------------
	Shader gBufferShader(".\\shader\\gBufferShader.vs", ".\\shader\\gBufferShader.fs");
	Shader lightingPassShader(".\\shader\\lightingPassShader.vs", ".\\shader\\lightingPassShader.fs");
	Shader shaderLightBox(".\\shader\\lightBox.vs", ".\\shader\\lightBox.fs");
	
	Shader pointLightShader(".\\shader\\pointLightShader.vs", ".\\shader\\pointLightShader.fs");
	Shader dirLightShader(".\\shader\\dirLightShader.vs", ".\\shader\\dirLightShader.fs");

	Shader stencilTestShader(".\\shader\\stencilTestShader.vs", ".\\shader\\stencilTestShader.fs");
