...
// --------------------
	...
	// ------------------------------------
	Shader bloomShader(".\\shader\\bloomShader.vs", ".\\shader\\bloomShader.fs");
	Shader lightShader(".\\shader\\lightShader.vs", ".\\shader\\lightShader.fs");
	Shader blurShader(".\\shader\\blurShader.vs", ".\\shader\\blurShader.fs");
	Shader bloomFinalShader(".\\shader\\bloomFinalShader.vs", ".\\shader\\bloomFinalShader.fs");
