...
int main()
{
	...
	// ------------------------------------
#if LEARNOPENGL
	Shader shaderGeometryPass(".\\shader\\gBufferShader.vs", ".\\shader\\gBufferShader.fs");
	...
	#else 
		Shader shaderGeometryPass(".\\shader\\oglGPass.vs", ".\\shader\\oglGPass.fs");
		Shader shaderLightingPass(".\\shader\\oglLighting.vs", ".\\shader\\oglLighting.fs");
		Shader shaderSSAO(".\\shader\\oglssao.vs", ".\\shader\\oglssao.fs");
		Shader shaderSSAOBlur(".\\shader\\oglBlur.vs", ".\\shader\\oglBlur.fs");
	#endif
#endif // LEARNOPENGL

	// load models
	// -----------
	nanosuit = Model(".\\models\\nanosuit\\nanosuit.obj");

	// textures
	// --------
	woodTexture = loadTexture(".\\images\\wood.png", false);
