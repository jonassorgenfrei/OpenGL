...
int main()
{
	...
	// main
	Shader groundShader(FileSystem::getPath("shader/ground.vert").c_str(), FileSystem::getPath("shader/ground.frag").c_str());
	Shader grassShader(FileSystem::getPath("shader/billboards.vert").c_str(), FileSystem::getPath("shader/billboards.frag").c_str(), FileSystem::getPath("shader/billboards.geom").c_str());
