...
// --------------------
	...
	// ------------------------------------
	Shader bloomShader(FileSystem::getPath("shader/bloomShader.vs").c_str(), FileSystem::getPath("shader/bloomShader.fs").c_str());
	Shader lightShader(FileSystem::getPath("shader/lightShader.vs").c_str(), FileSystem::getPath("shader/lightShader.fs").c_str());
	Shader blurShader(FileSystem::getPath("shader/blurShader.vs").c_str(), FileSystem::getPath("shader/blurShader.fs").c_str());
	Shader bloomFinalShader(FileSystem::getPath("shader/bloomFinalShader.vs").c_str(), FileSystem::getPath("shader/bloomFinalShader.fs").c_str());
